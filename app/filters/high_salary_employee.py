...
class HighSalaryEmployeeFilter(Filter):
    """Filter employees with salary above a specified threshold."""
    ...
    def apply(self, employees: pd.DataFrame) -> pd.DataFrame:
        """Filter employees with salary above the specified threshold."""
